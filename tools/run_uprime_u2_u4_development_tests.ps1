...
tracked = (
    *(artifact_root + '/' + name for name in (
    ...
    'docs/experiments/uprime_odlrq_u2_u4_development_construction_closeout_2026-07-13.md',
...
if any(path not in allowed_dirty for path in value["status_paths"]):
...
if lane in {"EMIT", "CLOSEOUT"}:
    ...
    previous = "14234e209229931c00615d4b171620ec6d1bbbf5"
    ...
    status = set(control["status_paths"])
