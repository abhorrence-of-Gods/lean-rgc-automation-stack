...
def test_domain_split_command_handlers_live_in_domain_modules():
    ...
    cases = {
        ...
        "batch-audit": (["batch-audit", "--tasks", "tasks.jsonl", "--out", "out"], "lean_rgc.cli.audit"),
        "server-audit": (["server-audit", "--tasks", "tasks.jsonl", "--out", "out"], "lean_rgc.cli.audit"),
        "repair-species-registry": (["repair-species-registry", "--out", "registry.jsonl"], "lean_rgc.cli.crg"),
        "crg-build-problems": (["crg-build-problems", "--out", "problems.jsonl"], "lean_rgc.cli.crg"),
        "concept-geometry": (["concept-geometry", "--out", "concepts"], "lean_rgc.cli.crg"),
        "poms-status": (["poms-status", "--run-dir", "run"], "lean_rgc.cli.poms"),
        "failure-attribution-report": (["failure-attribution-report", "--db", "runs.db"], "lean_rgc.cli.poms"),
    }
