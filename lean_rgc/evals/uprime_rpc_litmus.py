...
EVIDENCE_MILESTONE_2B_PHASE1B2_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase1b2_contract_oracle_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE1B2_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase1b2_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2A_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2a_bundle_reservation_forward_only_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2A_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2a_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B1_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b1_local_attempt_manifest_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B1_WINDOWS_BINDING_CORRECTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b1_windows_stat_binding_correction_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B1_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b1_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2A_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2a_seeded_local_inventory_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2A_EXECUTION_PATH = Path(
    "docs/experiments/"
...
EVIDENCE_MILESTONE_2B_PHASE2B2B_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2b_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2C_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2c_in_memory_fake_cas_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2C_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2c_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2D_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2d_nonce_staging_fake_publisher_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2D_EXECUTION_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2d_execution_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2E_AMENDMENT_PATH = Path(
    "docs/experiments/"
    "uprime_odlrq_u1_evidence_milestone_2b_phase2b2e_synthetic_recovery_coordinator_amendment_2026-07-11.md"
)
EVIDENCE_MILESTONE_2B_PHASE2B2E_EXECUTION_PATH = Path(
    "docs/experiments/"
...
UPPER_STACK_IMPLEMENTATION_PLAN_AND_U05_AMENDMENT_PATH = Path(
    "docs/experiments/"
...
LOCAL_ARTIFACT_OBSERVER_SOURCE_PATH = Path(
...
ANCHOR_PATHS = (
    ...
    EVIDENCE_MILESTONE_2B_PHASE1B2_AMENDMENT_PATH,
    EVIDENCE_MILESTONE_2B_PHASE1B2_EXECUTION_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2A_AMENDMENT_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2A_EXECUTION_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2B1_AMENDMENT_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2B1_WINDOWS_BINDING_CORRECTION_PATH,
    ...
    EVIDENCE_MILESTONE_2B_PHASE2B2B_EXECUTION_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2B2C_AMENDMENT_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2B2C_EXECUTION_PATH,
    EVIDENCE_MILESTONE_2B_PHASE2B2D_AMENDMENT_PATH,
    ...
    INTEGRATED_SYNTHETIC_MANIFEST_SOURCE_PATH,
    INTEGRATED_SYNTHETIC_MANIFEST_TEST_SUPPORT_PATH,
    PACKAGE_INIT_PATH,
