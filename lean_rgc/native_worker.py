...
KERNEL_RPC_WORKER_VERSION = "lean-rgc-native-worker-v49-kernel-rpc-v1"
...
def packaged_worker_path() -> Path:
    return Path(__file__).resolve().parent / "native_lean" / "RGCKernelWorker.lean"


def packaged_kernel_rpc_worker_path() -> Path:
    return Path(__file__).resolve().parent / "native_lean" / "RGCKernelRPC.lean"
...
def install_native_worker(workdir: str | Path | None = None, *, force: bool = False, subdir: str = ".lean_rgc", lean_cmd: str = "lake env lean", exec_mode: str = "source_check") -> NativeWorkerInstall:
...
def native_worker_command(*, worker_path: str | Path | None = None, workdir: str | Path | None = None, lean_cmd: str = "lake env lean", exec_mode: str = "source_check", extra_args: list[str] | None = None) -> str:
...
def native_worker_manifest(workdir: str | Path | None = None, *, lean_cmd: str = "lake env lean", force: bool = False, exec_mode: str = "source_check") -> dict[str, Any]:
