...
rational predictive and componentwise-window development cores, the pure
canonical-history/raw-D4 core, and the typed finite-level similarity core are
exported.  Learners and production Lean certificates remain outside this
milestone.
"""
